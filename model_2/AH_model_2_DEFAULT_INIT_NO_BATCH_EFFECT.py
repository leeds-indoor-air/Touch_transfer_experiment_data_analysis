...
transformed parameters {
...

    {
        ...
        for(n in 1:N){
                ita = beta_0[material[n]] + beta_1[material[n]] * AH[n];
...
model {
    ...
    for(l in 1:L){
            target += normal_lpdf( beta_0[l] | 0.0, 1e2 );
            target += normal_lpdf( beta_1[l] | 0.0, 1e2 );
...
fit.to_pickle('AH_model_2_DEFAULT_INIT_NO_BATCH_EFFECT_' + ss +  '.fit')
