...
beta_0_plot.savefig('model_2/trace_plots/' + _file + '_NO_BATCH_EFFECT_beta_0_trace.png')
...
beta_1_plot.savefig('model_2/trace_plots/' + _file + '_NO_BATCH_EFFECT_beta_1_trace.png')
...
M_plot.tight_layout()
M_plot.savefig('model_2/trace_plots/' +  _file + '_NO_BATCH_EFFECT_M_trace.png')
...
log_phi_plot.savefig('model_2/trace_plots/' + _file + '_NO_BATCH_EFFECT_log_phi_trace.png')
...
lp_plot.savefig('model_2/trace_plots/' + _file + '_NO_BATCH_EFFECT_lp__.png')
