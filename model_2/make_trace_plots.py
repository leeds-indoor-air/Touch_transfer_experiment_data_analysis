...
beta_0_plot.savefig('model_2/trace_plots/' + _file + '_beta_0_trace.png')
...
beta_1_plot.savefig('model_2/trace_plots/' + _file + '_beta_1_trace.png')
...
M_plot.tight_layout()
M_plot.savefig('model_2/trace_plots/' + _file + '_M_trace.png')
...
log_phi_plot.savefig('model_2/trace_plots/' + _file + '_log_phi_trace.png')
...
log_sigma_plot.savefig('model_2/trace_plots/' +  _file + '_log_sigma_trace.png')
...
lp_plot.savefig('model_2/trace_plots/' +  _file + '_lp__.png')
...
tau_plot.savefig('model_2/trace_plots/' + _file + '_tau_trace.png')
