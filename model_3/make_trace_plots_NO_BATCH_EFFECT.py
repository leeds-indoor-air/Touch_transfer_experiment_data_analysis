...
for ch in chains:
    ax[0].plot(np.array(ch['beta_0']), alpha=0.33)
    ax[1].plot(np.array(ch['beta_1']), alpha=0.33)
...
beta_plot.savefig('model_3/trace_plots/' + _file + '_NO_BATCH_EFFECT_beta_trace.png')
...
M_plot.tight_layout()
M_plot.savefig('model_3/trace_plots/' + _file + '_NO_BATCH_EFFECT_M_trace.png')
...
log_phi_plot.savefig('model_3/trace_plots/' + _file + '_NO_BATCH_EFFECT_log_phi_trace.png')
...
lp_plot.savefig('model_3/trace_plots/' + _file + '_NO_BATCH_EFFECT_lp__.png')
